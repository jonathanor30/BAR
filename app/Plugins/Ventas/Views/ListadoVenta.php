      ...
      <div class="col-md-7">
         ...
         <div class="btn-group">
            <div class="dropdown">
               ...
               <a href="<?php echo RUTA_URL ?>/Ventas/CrearVenta"><button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i> Nuevo</button></a>
...
<script src="<?php echo RUTA_URL; ?>/Ventas/files?js=recursos/js/Ventas.js"></script>
