...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h3> Detalle De La Compra #<?php echo $datos['datocompra']->IdCompra; ?></h3>
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm">
                    <label>Nombre</label>
                    <input type="text" class="form-control form-control-sm" id="ClieNombre" name="ClieNombre" readonly="" required="" value="<?php echo $datos['datocompra']->Nombre; ?>">
                </div>
                <div class="col-sm">
                    <label>Telefono</label>
                    <input type="text" class="form-control form-control-sm" id="ClieTelefono" name="ClieTelefono" readonly="" required="" value="<?php echo $datos['datocompra']->Telefono; ?>">
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-sm">
                    <label>Fecha</label>
                    <input class="form-control form-control-sm" readonly id="fecha" placeholder="" type="date" value="<?php echo $datos['datocompra']->fecha; ?>" name="FacFecha" required="">

                </div>
                <div class="col-sm">
                    <label>Hora</label>
                    <input class="form-control form-control-sm" readonly id="ref" placeholder="" type="text" value="<?php echo $datos['datocompra']->hora; ?>" name="FacRef">
            ...
            <div class="table-responsive-sm">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" readonly name="FacObservacion"><?php echo $datos['datocompra']->observaciones; ?></textarea>
                </div>
            </div>
