...
$("#datos_factura").submit(function(event) {
  ...
  $.ajax({
    type: "POST",
    url: ruta + "/Novedades/SaveinvProv",
    data: parametros,
...
/*
function ObtenerTipoDeNovedad() {
  $.ajax({
    url: ruta + `/Novedades/ObtenerTiposDeNovedades`,
    type: "POST",
    contentType: false,
    cache: false,
    processData: false,
    success: function (resultado) {
      var x = document.getElementById("IdTipoNovedad");
      //Acá estamos pintando los tipos de productos
      for (var r in resultado) {
    var option = document.createElement("option");
          option.text = resultado[r].Nombre_Novedad;
          option.value = resultado[r].IdTipoNovedad;
...
function ObtenerTipoDeProducto() {
  $.ajax({
    url: ruta + `/Novedades/ObtenerTiposDeProducto`,
    type: "POST",
    contentType: false,
    cache: false,
    processData: false,
    success: function (resultado) {
      ...
      for (var r in resultado) {
    var option = document.createElement("option");
    option.text = resultado[r].NombreProducto+" "+resultado[r].Nombre;
    option.value = resultado[r].CodigoProducto;
...
function ObtenerPrecio() {
  ...
  $.ajax({
    ...
    url: ruta + `/Novedades/ObtenerPrecios`,
    type: "POST",
