         ...
         <div class="modal-body">
            <form class="form-horizontal" action="" id="guardar_usuario" method="POST" autocomplete="off">
               ...
               <div class="row">  
                  ...
                  <div class="col-sm">
                     <label for="StockMaximo" class="col-form-label">Sctok minimo<b style="color:gray;">*</b></label>
                     <input type="" class="form-control form-control-sm" id="StockMaximo"  name="StockMaximo" placeholder="Stock minimo" required="">
                  </div>
               </div>
               <div class="row">  
                  <div class="col-sm-6">
                     <label for="StockMaximo" class="col-form-label">Sctok maximo<b style="color:gray;">*</b></label>
                     <input type="" class="form-control form-control-sm" id="StockMaximo" name="StockMaximo" placeholder="Stock maximo"  required="">
                  </div>
                  <div class="col-sm">
                     <label for="ImagenProducto" class="col-form-label">Imagen producto<b style="color:gray;">*</b></label> 
							<input  id="fileUpload" name="ImagenProducto" type="file"/>
