<cac:<?php echo e($node); ?>>
    ...
    <cac:Party>
        ...
        <cac:Contact>
            ...
            <cbc:ElectronicMail><?php echo e($empresa->email); ?></cbc:ElectronicMail>
        </cac:Contact>
    </cac:Party>
</cac:<?php echo e($node); ?>>

<?php /**PATH /var/www/html/GTEP/app/Plugins/Facturacion/Views/xml/_accounting.blade.php ENDPATH**/ ?>