<cac:<?php echo e($node); ?>>
    ...
    <cbc:PayableAmount currencyID="<?php echo e($invoice->Client()->first()->coddivisa); ?>"><?php echo e(number_format($invoice->total + $invoice->totalretencion - ($invoice->prepaids()->sum('importe')!=NULL && isset($number_fe) ?$invoice->prepaids()->sum('importe'): 0), 2, '.', '')); ?></cbc:PayableAmount>
    <?php else: ?>
    <cbc:PayableAmount currencyID="<?php echo e($invoice->Client()->first()->coddivisa); ?>"><?php echo e(number_format($invoice->total + $invoice->totalretencion, 2, '.', '')); ?></cbc:PayableAmount>
    <?php endif; ?>
</cac:<?php echo e($node); ?>>
<?php /**PATH /var/www/html/GTEP/app/Plugins/Facturacion/Views/xml/_legal_monetary_total.blade.php ENDPATH**/ ?>