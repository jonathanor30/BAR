...
<body>
                ...
                <td colspan="2" style='background-color: #ffffff;'>
                    <div style='color: #2C3E50; font-family: sans-serif'>
                        <h5 style='color: #052d4b; margin: 0 0 7px'>Esta es una notificación de una nueva
                            {{ $documento }} generada.</h5><br>
                        <p><strong>En los adjuntos encontraŕa el pdf y el archivo xml.</strong></p>
                    </div>
                </td>
            </tr>
            @if (in_array($factura->estadodian2, [null, '']))
                <tr>
                    <td style='background-color: #ffffff; text-align:center'>
                        <a target="_blank" href="{{ $rutaA }}" class="btn btn-sm btn-primary">Aceptar</button>
                    </td>
                    <td style='background-color: #ffffff; text-align:center'>
                        <a target="_blank" href="{{ $rutaR }}" class="btn btn-sm btn-warning">Rechazar</button>
                    </td>
                </tr>
            @endif
        </tbody>
    ...
    <p style='color: #22222; font-size: 10px; text-align: center;margin: 30px 0 0; font-family: sans-serif;'>Generado,
        firmado y enviado por <strong>{{ $APP_NAME }}</strong><br>Negocio, reescrito por software</p>
</body>
