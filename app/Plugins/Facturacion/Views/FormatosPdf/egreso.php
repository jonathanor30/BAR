...
<page backtop="38mm" backbottom="6mm" backleft="6.5mm" backright="6.5mm" style="font-size: 12px; font-family: Arial" footer="page">
   ...
   <h4 style="text-align: center;">RECIBO DE EGRESO No <?php echo $recibo[0]->numero ?></h4>
   <table id="customers" cellspacing="0" style="width: 100%; text-align: left;">
      <tr>
         <td style="width: 25%"><strong>Egreso No</strong></td>
         <td style="width: 25%; text-align: center;">
            <?php echo $recibo[0]->numero ?>
         </td>
         <td style="width: 25%"><strong>Factura No</strong></td>
         <td style="width: 25%; text-align: center;">
            <?php if ($recibo[0]->idfactura != null) {
      ...
      <tr>
         ...
         <td style="width: 25%; text-align: center;">
            <?php echo $proveedor->telefono1 ?>
         </td>
      </tr>
      <tr>
         <td style="width: 25%"><strong>Importe Egreso</strong></td>
         <td style="width: 25%; text-align: center;">
            <?php echo "$  " . $recibo[0]->importe ?>
         </td>
         <td style="width: 25%"><strong>Estado</strong></td>
         <td style="width: 25%; text-align: center;">
            <?php switch ($recibo[0]->estado_recibo) {
               case 0:
                  echo "Emitido";
                  break;
               case 1:
      ...
      <tr>
         ...
         <td style="width: 25%"><strong>Vencimiento</strong></td>
         <td style="width: 25%; text-align: center;">
            <?php echo $recibo[0]->vencimiento ?>
         </td>
      </tr>
   ...
   <table id="customers" cellspacing="0" style="width: 100%; text-align: left;">
      <tr>
         <td style="width: 50%" ;>
            ...
            <br>
            <?php echo $recibo[0]->observaciones ?>
            <br><br><br>
         </td>
         <td style="width: 50%" ;>
            <strong>Firma:</strong>
