      ...
      <form id="FormEditarProducto" action="" method="POST">
        <div class="row">
          <div class="col-sm">
            ...
            <input type="hidden" id="IdMarca" name="IdMarca" value="<?php echo $datos['home']->IdMarca ?>">
          </div>
        </div>
    </div>
...
<script>
  ...
  document
    ...
    .addEventListener("submit", function(e) {
      ...
      $.ajax({
        type: "POST",
        url: ruta + "/Configuracion/EditarMarca",
        data: parametros,
        ...
        success: function(datos) {
          ...
          if (datos == "true") {
            ...
            alertify.success(
              '<h6><i class="fas fa-check"></i> Marca editada  correctamente</h6>'
            );
          } else {
            $("#BtnEditProducto").attr("disabled", false);
