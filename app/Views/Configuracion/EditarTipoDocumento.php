...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h4 id="TituloProducto"><?php echo $datos['home']->Nombre_Documento ?></h4>
        </div>
        <div class="card-body">
            ...
            <form id="FormEditarProducto" action="" method="POST">
                <div class="row">
                    <div class="col-sm">
                        <label>TipoDocumentoo</label>
                        <br><br>
                        <input class="form-control form-control-sm" type="text" name="Nombre_Documento" id="Nombre_Documento" value="<?php echo $datos['home']->Nombre_Documento ?>" />
                        <input type="hidden" id="IdTipoDocumento" name="IdTipoDocumento" value="<?php echo $datos['home']->IdTipoDocumento ?>">
                    </div>
...
<script>
    ...
    document
        .getElementById("Nombre_Documento")
    ...
    document
        ...
        .addEventListener("submit", function(e) {
            ...
            $.ajax({
                type: "POST",
                url: ruta + "/Configuracion/EditarTipoDocumento",
                data: parametros,
                ...
                success: function(datos) {
                    ...
                    if (datos == "true") {
                        ...
                        alertify.success(
                            '<h6><i class="fas fa-check"></i> Tipo documento  editado correctamente</h6>'
                        );
                    } else {
                        $("#BtnEditProducto").attr("disabled", false);
