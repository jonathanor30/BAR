...
<html lang="<?php echo LANG;?>">
  ...
  <body style="background-color:#8A8989;">
...
<div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="jumbotron">
                    <h1>
                        <i class="fas fa-users" aria-hidden="true"></i> Este proveedor no tiene ninguna compra asociada.
                    </h1>
                    <hr class="my-4">
                    <br><br>
                    <a href="http://localhost/Bar70\Proveedores" class="btn btn-primary">
